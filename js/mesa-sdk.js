...
window.MesaSDK = (() => {
  ...
  // globals:@stellar/stellar-sdk
  var require_stellar_sdk = __commonJS({
    "globals:@stellar/stellar-sdk"(exports, module) {
      "use strict";
      module.exports = window.StellarSdk;
    }
  });

  // globals:@stellar/freighter-api
  var require_freighter_api = __commonJS({
    "globals:@stellar/freighter-api"(exports, module) {
      "use strict";
      module.exports = window.FreighterAPI || window.freighterApi || window.FreighterApi;
    }
  });
  ...
  var import_stellar_sdk6 = __toESM(require_stellar_sdk(), 1);

  // src/provider.ts
  var import_stellar_sdk = __toESM(require_stellar_sdk(), 1);
  ...
  // src/freighter.ts
  var freighter = __toESM(require_freighter_api(), 1);
  ...
  // src/factory.ts
  var import_stellar_sdk2 = __toESM(require_stellar_sdk(), 1);
  ...
  // src/circle.ts
  var import_stellar_sdk3 = __toESM(require_stellar_sdk(), 1);
  ...
  // src/vault.ts
  var import_stellar_sdk4 = __toESM(require_stellar_sdk(), 1);
  ...
  // src/signer.ts
  var import_stellar_sdk5 = __toESM(require_stellar_sdk(), 1);
